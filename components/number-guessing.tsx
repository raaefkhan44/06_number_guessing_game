...
export default function NumberGuessing(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-purple-950 to-white">
      <div className="bg-gradient-to-t from-purple-700 to-gray-300 rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        {gameStarted && !gameOver && (
          <div>
            ...
            <div className="flex justify-center mb-4">
              ...
              <Button
                onClick={handleGuess}
                className="bg-black hover:bg-gray-600 text-white font-bold py-2 px-4 rounded ml-4"
              >
                Guess
              </Button>
            </div>
            <div className="text-center text-black font-serf">
